...
そして、この二つ目の記録を読むのは、機能ではない。能力だ。キーパーソン検知は機能であって、どんなダッシュボードにも後付けできるし、競合が来期には同じものを出す。観測はその下の層だ。生き残った方を一度読めば、その種の機能が一つのシグナルから何個も落ちてくる。機能はコピーされる。能力はカテゴリを作る。
...
画面から一歩引いて、これは何のためかと問う。CTO が買うのはトポロジー図ではない。書いた人がいなくなっても残る知識だ。キーパーソンの集中を名指すのと同じ生き残りの層が、知識が次のオーナーへ継承できているか――できていないか――、誰が抜けたら寝耳に水になるか、レビュー文化が実際どうなっているか、採用の判断が事実か勘か、それを同時に映す。画面は別々でも、能力はひとつだ。退職を越えて残る知識、不意打ちにならない離職、勘ではなく記録で決めるオンボーディングと採用。

そして、その全部の下に一つのものが横たわっている。人は辞める。組織は組み替わる。コードは書き直される。その全部を通り抜けて組織が残したいのは、人ではない――人は留められない――その人が持っていた知識だ。EIS と Ace が守ろうとしているのは、それだ。名前がある。継承だ。観測は、いまいる人を採点するためにあるのではない。その人が知っていることが、その人の在籍より長く残るためにある。観測の文化とは、継承の文化のことだ。
