...
React（延べ1,927人が通過）の通期の重力でトップに立つのは Sebastian Markbåge だ。Indispensability 100、Catalysis 100。構造の形は飽和し、他の全員が彼の上に築いている。
...
大半の人は、Markbåge ではない。そして残る影響力は、誰のコードが書き換えられずに生き残ったか、だけで決まるわけではない。次の構造が立つための足場になる仕事が、いちばん効くこともある。Andrew Clark は、その一例だ。彼は Hooks、Concurrent Mode、Suspense と React の中核を書き、その多くは後の世代に上書きされた。EIS は生き残った構造を読むので、書き換えられた土台は静かに映る。だが、その静けさこそが要点だ。**書き直されることは、失敗ではない。** 次の世代がその上に立つ、土台になったということだ。
...
そして Ace では、この二つは選ぶものではない。同じ人を、通期（生涯に残した構造）と軌跡（どの時代に担ったか）の両方で、切り替えひとつで読める。生涯のフットプリントと、季節ごとの推移。どちらかが、どちらかを消すことはない。Markbåge は通期で土台として立ち、軌跡では 2023 年のピークを見せる。Clark は通期で静かに、軌跡では席を担い続けた各シーズンを残す。望遠鏡を引いて全体を、寄って一時代を――同じ宇宙を、二つの焦点距離で読む。
