...
そしてこの記録は、組織のものだけではない。git に残ったあなたの仕事は、自己申告でも書いた量でもなく、周りが使い続けたという事実だ。いつか離れた会社が Ace で観測すれば、あなたがそこにいた時期の観測結果を、あなた自身が受け取れる（→ [自分の記録を claim](https://api.orbitlens.io/oss/claim)）。会社をまたいで積み上がっていくのは、盛った職務経歴書ではなく、事実からなるキャリア年表になっていくはずだ。
