---
title: "Reading Log #7 — Aoashi × Guns, Germs, and Steel × Distinction"
series: "Reading Log"
published: true
description: "The Japan/Spain gap isn't talent — it's environment and accumulated heat (Diamond). A seven-division league pyramid is the thickness of football rooted as culture; Barça's pass-soccer is habitus, an environment-built 'normal' the body knows before thought (Bourdieu). Environment backs the résumé — yet the individual re-chooses environment and carves a path. Observation that ignores environment misreads an environment gap as a talent gap."
...
- Jared Diamond, *Guns, Germs, and Steel* — [Amazon](https://www.amazon.com/s?k=Guns+Germs+and+Steel+Diamond)
...
The Japanese version lives on [OrbitLens Library](https://library.orbitlens.io/reading-log/7/).
