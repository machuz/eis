---
title: "Reading Log #6 — Aoashi × The Selfish Gene × The Protestant Ethic"
series: "Reading Log"
published: true
description: "To cultivate is to replicate a meme (Dawkins) — and the bliss is when the copy surpasses the original. But a meme only takes hold when the receiver chooses it. Devotion to the place is a calling/Beruf (Weber); guard it from the iron cage. A life given to one club doesn't vanish — it's passed on even without you. The heat to cultivate is dark matter that observation must not nullify."
...
![“I found someone I absolutely want to cultivate” — the moment a near-spent heat lights again](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/hatena/reading-log-6-sodatetai.png)
...
![“Believe you are ‘ones who grow.’ I can guide you, endlessly” — the cultivator's unshaken faith](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/hatena/reading-log-6-shinjite.png)
...
![“There was a ‘blissful moment’ in cultivating” — a coach of twenty years recalls](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/hatena/reading-log-6-shifuku.png)

It's **when a player you taught surpasses your own imagination.**

![“When they surpassed my imagination” — the copy overtakes the original](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/hatena/reading-log-6-koete.png)
...
![“I found it…” — the cultivated one finds the person to aim at](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/hatena/reading-log-6-mitsuketa.png)

That person is Akihiro Shiba. A player who fights with his head, called the "thinking reed."

![“A ‘thinking reed’” — Shiba, the role model Ashito chose](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/hatena/reading-log-6-ashi.png)

Ashito looks at him and decides, "I'll become this person." The moment whom-to-inherit is set, the path opens all at once.

![“I'll become this person. My path opens, all at once” — choosing whom to inherit, yourself](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/hatena/reading-log-6-konohito.png)
...
![“I want to stay here forever” — the prayer of a coach near retirement](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/hatena/reading-log-6-eien.png)
...
![“A soccer life devoted to one club. I'm satisfied now” — it'll be passed on, even without me](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/hatena/reading-log-6-farewell.png)
...
- Richard Dawkins, *The Selfish Gene* — [Amazon](https://www.amazon.com/s?k=The+Selfish+Gene+Dawkins)
- Max Weber, *The Protestant Ethic and the Spirit of Capitalism* — [Amazon](https://www.amazon.com/s?k=Protestant+Ethic+Spirit+of+Capitalism+Weber)
...
The Japanese version lives on [OrbitLens Library](https://library.orbitlens.io/reading-log/6/).
