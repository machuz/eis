...
Most of us are not Markbåge — and durable impact isn't only about whose code survives unchanged. Sometimes the work that matters most is the scaffold that lets the next structure exist. Andrew Clark is one of those cases: he wrote huge parts of React's modern internals — hooks, concurrent mode, Suspense — and much of it was later built over by the generation that followed. Because EIS reads surviving structure, a foundation that's been rewritten on top of reads quiet. But that quiet is the point. **Being rewritten isn't failure** — it often means the work became the foundation the next generation stands on.
