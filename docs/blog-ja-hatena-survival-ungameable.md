...
人を測るのに使われてきた指標を思い浮かべてほしい。たぶん全部、本体をやらずに数字だけ動かす方法が、誰かの手で静かに見つかっている。

行数は打った量に報酬を出したので、みんな打った。コミット数はコミットに報酬を出したので、コミットは細かく刻まれた。ベロシティは消化ポイントに報酬を出し、ポイントはじわじわ膨らんで「3」がほとんど何も意味しなくなった。DORA はデプロイ頻度を測り、些末な変更が勝手に流れ始める。code health 系が寄りかかる churn ですら、意図的に下げられる数字だ。下げられるということは、その下にある散らかりの代わりに、数字の方を管理できてしまうということでもある。
...
最後の手が、正体を明かす。誰も触らない私的帝国を築いても、gravity の重みは「他人がその上に積んだか」を訊く。それだけは、自分では供給できない。他人が、何ヶ月もかけて、あなたの仕事を土台に選ぶか、邪魔だと剥がすかで、寄与する。スコアの中で、自分の手を通らない唯一の項だ。

どのゲーム手も、活動量を経由する。survival は、活動量を引いた後に残るものだ。引かれる側をいくら足しても、残りかすは膨らまない。
...
主張はこれだけで、しかも小さい。誰を昇進させるべきか、次にどのファイルが壊れるかを告げる数字ではない。git が記録する全ての中で、survival だけが、もっと忙しくするでは動かせない唯一の測定だ、という一点。忙しさがタダになった年に、それが結局、読む価値の残った唯一の測定だった。
