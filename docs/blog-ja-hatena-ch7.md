...
EISを作っていて、最後に辿り着いた感覚はとてもシンプルだった。コードベースは宇宙のような構造を持っている、ということだ。

そこには重力がある。あるコードの周りに他のコードが集まり始める。抽象化がそこを通る。設計がそこを中心に組み上がる。すると構造の中心が生まれる。
...
これは強い構造だ。一貫性がある。迷いがない。しかし同時に、とても脆い構造でもある。
