...
しかし重要なのはここだ。本当に優れたArchitectは「自分がいなくなった後の宇宙」まで設計している。

良いArchitectが作った宇宙では、その人が去った後でも秩序が維持される。構造が残るからだ。設計の重力場が宇宙に残っている。
...
一方、Black Hole Engineerは成仏できない。去った瞬間にコード宇宙が崩壊するからだ。
...
Black Hole Engineerのタイムラインでは、ずっとArchitectのままだ。構造を手放さない。重力を集中させ続ける。
...
Black Holeの置き換えに必要なのは、同じ強さの重力ではない。質の違う重力だ。
...
良いArchitectも同じだ。去った後に残るのは、コードではなく構造だ。
