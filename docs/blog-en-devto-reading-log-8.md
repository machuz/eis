---
title: "Reading Log #8 — Aoashi × Finite and Infinite Games × Imagined Communities"
series: "Reading Log"
published: true
description: "A storied club is an imagined community made of shared story (Anderson); its culture is by nature an infinite game / magic circle (Carse). When soccer becomes 'appeal' and a merciless sieve, winning becomes the end and the infinite game gets swallowed by a finite one — with no malice anywhere. Yet a pure, equal core remains: the beauty of the harsh game is that the ball judges everyone equally. And the room for evolution always opens inside play."
...
![A packed stadium — the grandeur of the kingdom](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/hatena/reading-log-8-stadium.png)
...
![It's a magical place. Enjoy it fully while you can still stand — the core of play, outside winning and losing](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/hatena/reading-log-8-magic.png)
...
![Is there any purpose other than to appeal? — finite-game-ification, playing to be picked and to win](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/hatena/reading-log-8-appeal.png)
...
![Beyond the merciless sieve — a musical-chairs with your life staked](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/hatena/reading-log-8-furui.png)
...
![How pure, how equal a world — the most beautiful part of the harsh competition](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/hatena/reading-log-8-junsui.png)
...
- James P. Carse, *Finite and Infinite Games* — [Amazon](https://www.amazon.com/s?k=Finite+and+Infinite+Games+Carse)
- Benedict Anderson, *Imagined Communities* — [Amazon](https://www.amazon.com/s?k=Imagined+Communities+Benedict+Anderson)
...
The Japanese version lives on [OrbitLens Library](https://library.orbitlens.io/reading-log/8/).
