...
あるタイミングではあるエンジニアがシステムを駆動し、別のタイミングでは別の誰かがその役割を担う。固定値としてのスコアではなく、重心がいまどこにあるかを示すシグナルだ。

人やシステムに固定値を割り振ることはできないが、観測はできる。どこに勢いがあるか、どこに圧力がかかっているか、どこで安定が形成され、どこで崩れているか。
...
**Debt Cleanup** ——この指標を追加したとき、チームの「サイレントヒーロー」が可視化された。他の全員のバグを黙々と直し続けている人がいた。こういう人を、従来の指標は見えなくしてしまう。
...
**R.S.** —— Production 17は目を引かない。しかしSurvival 50（チーム2位）は、最近のコードが残っていることを意味する。Debt Cleanup 88は、他の全員のバグを黙々と直しているということだ。Debt Cleanupという軸は、こういう人を可視化するために設計された。AnchorというRoleがこれを完璧に捉えている。
