...
**重要な注意：** EISが測定しているのは**このコードベースへのインパクト**であり、エンジニアリング能力の絶対値ではない。Survivalが高いことが、リファクタリングできないコードを意味している場合すらある。観測結果が直感と合わない場合、調べる価値がある——それは人の問題ではなく、コードベースの設計上の問題を示しているかもしれない。（これを[Engineering Relativity](https://machuz.hatenablog.com/entry/git-archaeology-8-engineering-relativity)と呼んでいる。）
...
> トポロジー進化の詳細：[Chapter 3](https://machuz.hatenablog.com/entry/git-archaeology-3-two-paths-to-architect) と [Chapter 4](https://machuz.hatenablog.com/entry/git-archaeology-4-backend-architects-converge)
...
**Y.Y.** —— Design 67、Breadth 81。オリジナルのアーキテクト。Indispensability 100——アクティブなメンバーの誰よりも多くのモジュールがまだこの人に帰属している。トポロジーは `Architect / — / Former`——Roleはコードの中で、退職後もなお持続している。これは[Chapter 4](https://machuz.hatenablog.com/entry/git-archaeology-4-backend-architects-converge)が「成仏させるべき魂」と呼ぶシグナルだ——引き継ぎの優先対象。
...
- [Chapter 0: もしGit履歴が「誰が最も強いエンジニアか」を教えてくれるとしたら？](https://machuz.hatenablog.com/entry/git-archaeology-0-what-if-git-history)
- **Chapter 1: 履歴だけでエンジニアの「戦闘力」を定量化する**
- [Chapter 2: 個人を超えて：Git履歴からチームの健全性を測る](https://machuz.hatenablog.com/entry/git-archaeology-2-team-health)
- [Chapter 3: アーキテクトへの2つの道：エンジニアはどう進化するか](https://machuz.hatenablog.com/entry/git-archaeology-3-two-paths-to-architect)
- [Chapter 4: BEアーキテクトは収斂する：魂を成仏させる聖なる仕事](https://machuz.hatenablog.com/entry/git-archaeology-4-backend-architects-converge)
- [Chapter 5: タイムライン：シグナルは嘘をつかない、そして躊躇も記録する](https://machuz.hatenablog.com/entry/git-archaeology-5-timeline)
- [Chapter 6: チームは進化する：タイムラインが明かす組織の法則](https://machuz.hatenablog.com/entry/git-archaeology-6-teams-evolve)
- [Chapter 7: コードの宇宙を観測する](https://machuz.hatenablog.com/entry/git-archaeology-7-observing-the-universe)
- [Chapter 8: Engineering Relativity：同じエンジニアが異なるシグナルを得る理由](https://machuz.hatenablog.com/entry/git-archaeology-8-engineering-relativity)
- [Chapter 9: 起源：コード宇宙のビッグバン](https://machuz.hatenablog.com/entry/git-archaeology-9-origin)
- [Chapter 10: ダークマター：見えない重力](https://machuz.hatenablog.com/entry/git-archaeology-10-dark-matter)
- [Chapter 11: エントロピー：宇宙は常に無秩序に向かう](https://machuz.hatenablog.com/entry/git-archaeology-11-entropy)
- [Chapter 12: 崩壊：良いアーキテクトとブラックホールエンジニア](https://machuz.hatenablog.com/entry/git-archaeology-12-collapse)
- [Chapter 13: コードの宇宙論](https://machuz.hatenablog.com/entry/git-archaeology-13-cosmology)
- [Chapter 14: 文明——なぜ一部のコードベースだけが文明になるのか](https://machuz.hatenablog.com/entry/git-archaeology-14-civilization)
- [Chapter 15: AIは星を生む、重力ではなく](https://machuz.hatenablog.com/entry/git-archaeology-15-ai-creates-stars)
- [最終章: 重力を形作るエンジニアたち](https://machuz.hatenablog.com/entry/git-archaeology-16-the-engineers-who-shape-gravity)

---

[Chapter 2: チームの健全性 →](https://machuz.hatenablog.com/entry/git-archaeology-2-team-health)
