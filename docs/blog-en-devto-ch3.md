...
But staring at the data long enough, I noticed something else: architects don't all come from the same mold. There are two distinct evolution paths, and understanding them changes how you read the numbers, and the people behind them.
...
Producing like crazy, but Robust is only 11. Most of their code gets rewritten by R.M., yet they keep producing until 11% survives.

Anchor means they're trying to guard quality. Mass means their precision is still rough. Signals of struggle and signals of effort are both observable.

This isn't just "immature." They're in the early stage of an Anchor-to-Architect path, building the instincts for **Inheritance Architect**.
...
The only one outside the Architect generating real gravity. Engineers who can create gravity are genuinely rare.

But Dormant is high — much of their code hasn't been touched by others yet. They built ahead of the team. And Robust is low.
...
In fact, while writing this article and analyzing O.'s state, something clicked. "High Gravity + producing code + but low Robust" — this combination wasn't captured by existing Styles. It was being labeled Balanced, but that's wrong: this is exactly what an Emergent Architect candidate looks like.
...
Here's what struck me looking at this data: these metrics visualize the stories that accumulate day by day.
...
There's an important nuance here: Gravity comes in two flavors.
...
R.M. has structural gravity. O. has occupancy gravity. But this isn't a dismissal of O.: occupancy gravity is the precursor to structural gravity.
...
There's another important state EIS makes visible: **State: Fragile**.
...
Why? Because the current structure and the next structure coexist.
...
Remove any one and the ecosystem breaks. Architects alone create structure but no features. Producers alone build features but structure crumbles. Without Anchors, both structure and features rot over time. A healthy codebase has all three coexisting.

---

## Two Evolution Paths

Now for the main thesis: architects come in two schools.
...
Backend tends to have clearer responsibility separation, domain boundaries, and "closer to correct" designs. So copying good structure, guarding it, and purifying it has high value.
...
So a frontend Architect who only inherits the correct answer is weak. What's needed is someone who brings a different structural proposal, clashes with existing structure, and forges a stronger gravitational field. In frontend, the collision of ideas is beautiful.
...
isn't just immaturity. It can also mean proposing new structure that competes with the existing one.
...
This doesn't mean "unlikely to become Architect." It means they have the foundation for Inheritance Architect, but the style is still rough.
...
Career paths aren't a single line. They're a branching evolution model. And the two types aren't opposites — they're complementary.
...
On the flip side, there's a dangerous team composition: everyone is a Producer.

It looks active. Code ships daily. PRs merge constantly. But:
...
No Architect. No Anchor. No Cleaner. Complementarity signal tanks.
...
This isn't "one Architect + followers." The current structure and the next structure coexist. That's strong.

---

## What This Discovery Means

This discovery elevates EIS's career model: not a single line, but a branching evolution model. And that's also a theory of team design.
