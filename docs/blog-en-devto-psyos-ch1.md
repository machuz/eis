...
**You can't directly observe your own Psychological OS.** The reason is structural: observer and observed are the same system.

Structure-driven theory handles the outside — git logs, review signals, timeline data. All of it lands on the ledger, observable without routing through identity.

Psychological OS isn't like that. The observation apparatus (your own cognition) and the observation target (your Psychological OS) can't be separated. And this apparatus **breaks down most precisely when the target is broken**. People who are collapsing are least likely to notice the collapse. This isn't a cognitive distortion; it's a **structural blind spot**.
...
**The moment the success coffin closes** has no symptoms. It's often experienced as "fulfillment." The winning pattern stabilizes. Evaluations become predictable. Expectations from those around you become readable. From outside, it looks like success. From inside, it's the moment **the next move is no longer required**. And noticing that takes time.

**Agreeing to mass hypnosis** is hard to distinguish from "being convinced." When you start saying what everyone else says, it might be because you actually agree — or because you're performing agreement to get through. Both are indistinguishable from inside.
...
Since direct observation isn't possible, people with strong Psychological OS have **ways to create distance between observer and target**. If you can break the identity for even a moment, observation becomes possible. Three approaches:
...
## 3. Inquiry — draw guidelines on yourself

Since external observers don't work, you need to **deliberately place guidelines**. A few candidates:
...
Not something you were asked to do. Not something continuing by momentum. Something **you initiated**, in the last stretch of time. If nothing, Psychological OS has already shifted to external drive.

**Can I still hold regret?**
...
Collapse isn't visible day to day. It's visible when compared with your self from six months ago. What matters is **recording, and reading back periodically**.
...
So a trustworthy reflection comes from **someone who returns your collapse as collapse, when you're collapsing**. Having such a person at all is itself load-bearing for maintaining Psychological OS.

## 6. A practice case — running the three-path cycle

Here's what using the three paths actually looks like. Take a typical symptom: "Lately, somehow, I can't move." The reason is not directly observable. You need proxy observation.
...
*What was my past self, six months ago, directing heat toward?* Open your notes, commit logs, chat history. Compare what your past self was oriented toward with your current self's orientation. **If the shift is toward exploration, healthy. If toward approval, a collapse signal.**
...
If all three paths point the same direction — "attached to the outside," say — the confidence that you're collapsing is high. **Triangulation raises observation precision.**

Only after observation do intervention options become legible. Move the attachment's target (ch2 §4). Row out of the organization (ch3 §5). Redesign the mesh (ch4 §3). **You can't intervene correctly without observing first.**
